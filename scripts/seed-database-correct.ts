...
async function seedDatabase() {
  ...
  try {
    ...
    const airports = [
      ...
      { icao_code: 'VVVH', iata_code: 'VII', name: 'Vinh International Airport', city: 'Vinh', country: 'Vietnam', country_id: countryMap.get('VN'), timezone: 'Asia/Ho_Chi_Minh', latitude: 18.7378, longitude: 105.6708 },
      ...
      { icao_code: 'VVCT', iata_code: 'VCA', name: 'Can Tho International Airport', city: 'Can Tho', country: 'Vietnam', country_id: countryMap.get('VN'), timezone: 'Asia/Ho_Chi_Minh', latitude: 10.0851, longitude: 105.7119 },
      ...
      { icao_code: 'VVCA', iata_code: 'VCL', name: 'Chu Lai International Airport', city: 'Tam Ky', country: 'Vietnam', country_id: countryMap.get('VN'), timezone: 'Asia/Ho_Chi_Minh', latitude: 15.4061, longitude: 108.7064 },
      { icao_code: 'VVTX', iata_code: 'THD', name: 'Tho Xuan Airport', city: 'Thanh Hoa', country: 'Vietnam', country_id: countryMap.get('VN'), timezone: 'Asia/Ho_Chi_Minh', latitude: 19.9017, longitude: 105.4681 },
      { icao_code: 'VVRG', iata_code: 'VKG', name: 'Rach Gia Airport', city: 'Rach Gia', country: 'Vietnam', country_id: countryMap.get('VN'), timezone: 'Asia/Ho_Chi_Minh', latitude: 9.9579, longitude: 105.1324 },
      ...
      { icao_code: 'VVPK', iata_code: 'PXU', name: 'Pleiku Airport', city: 'Pleiku', country: 'Vietnam', country_id: countryMap.get('VN'), timezone: 'Asia/Ho_Chi_Minh', latitude: 14.0045, longitude: 108.0170 },
      // Thailand
      ...
      { icao_code: 'VTSM', iata_code: 'USM', name: 'Samui Airport', city: 'Ko Samui', country: 'Thailand', country_id: countryMap.get('TH'), timezone: 'Asia/Bangkok', latitude: 9.5479, longitude: 100.0623 },
      // Singapore
