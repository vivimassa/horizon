export const moduleColors: Record<string, { bg: string; text: string; hsl: string }> = {
  ...
  admin:      { bg: 'bg-slate-500/15',  text: 'text-slate-600 dark:text-slate-400',   hsl: '215 14% 47%' },
}
