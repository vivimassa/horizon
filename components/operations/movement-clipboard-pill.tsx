...
import type { ClipboardState, UndoState } from '@/lib/hooks/use-movement-clipboard'

interface MovementClipboardPillProps {
...
export function MovementClipboardPill({ clipboard, undo, onClear, onUndo }: MovementClipboardPillProps) {
