...
import { X, RotateCcw, Check, Loader2, Settings2, Eye, Palette, Timer, BarChart3, MessageSquare } from 'lucide-react'
...
export function GanttSettingsPanel({
  open, onClose, settings, aircraftTypes, airports, serviceTypes, saveStatus,
                        ...
                        {activeTypes.map(t => (
                          <div key={t.id} className="flex items-center gap-2">
                            ...
                            <InlineColorPicker
                              ...
                              onChange={(c) => onUpdateColorAcType({ [t.icao_type]: c })}
                            />
                          </div>
                        ))}
                      </div>
